...
in {
  options.services.uptime = {
    ...
    enableWebService = mkOption { type = types.bool; default = false; };

    enableSeparateMonitoringService = mkOption { type = types.bool; default = false; } // { default = cfg.enableWebService; };
