...
let
  ...
  rev = "094e95e736723075d586d7a006c5525f2e3a74d4";
  date = "2016-12-16";
in
stdenv.mkDerivation {
  name = "wireguard-${date}";
  ...
  src = fetchzip {
    ...
    multihash = "QmXDmxUPSqMzKUXMksEKV59AfkaRAha6izT1aGm2TtNeRQ";
    sha256 = "c81d01c813c5d6ed19261aaee259955b2dee4f6b9601403b8d992e4613fc9cee";
  };
