...
let
  ...
  rev = "5c51d0f93892321256ede37c780341acfce9bd73";
  date = "2018-06-13";
in
stdenv.mkDerivation {
  ...
  src = fetchzip {
    ...
    multihash = "QmXCQg1sm9uNvW4SPfMbK9FfF63NRoLm6HF1J9PcaBQ6MN";
    sha256 = "9ce345422608077a6238a08d53256eb84059698fce0712c5e8fd7a35d22292a5";
  };
