...
let
  ...
  rev = "697c9a7df6f00c576e74120b0dfe4edb8761e39f";
  date = "2017-01-26";
in
stdenv.mkDerivation {
  name = "wireguard-${date}";
  ...
  src = fetchzip {
    ...
    multihash = "QmUi89DDAcJg1yGV7tp5ez3EcaptgrKHpp6UyCDwu5ExTU";
    sha256 = "9d3fccbf839a858c648e7edde3f221ec9cbab3c9f287c3a7aac315068bc01d2e";
  };
