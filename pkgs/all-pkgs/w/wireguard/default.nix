...
let
  ...
  rev = "ed8e1eac1c24cfdfb4c756af7f8ca7aaa99848a1";
  date = "2016-11-16";
in
stdenv.mkDerivation {
  name = "wireguard-${date}";
  ...
  src = fetchzip {
    ...
    multihash = "QmX438ERUuExosALpJaE3JfqT8t83Nst4CKVKouD97F2gR";
    sha256 = "89252cb35093844920a6d01c3e4a8285690dbf9d138313a35796f16b0e90ec7d";
  };
