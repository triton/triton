...
let
  ...
  rev = "824be84dd3aaa72a0d01241439f41733a4a1b742";
  date = "2016-11-29";
in
stdenv.mkDerivation {
  name = "wireguard-${date}";
  ...
  src = fetchzip {
    ...
    multihash = "QmPkx4CrXP4m7CamkXWbQj2tdJQt1JqNeWXVhCLUp6mwbA";
    sha256 = "d79a6f050d02348eb54a1d3dc23464f46c225c10a6183b6068c5beee5db1daeb";
  };
