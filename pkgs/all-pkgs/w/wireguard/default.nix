...
let
  ...
  rev = "2d01897620be55e3ba4f09388fab9335ac627fe7";
  date = "2017-01-15";
in
stdenv.mkDerivation {
  name = "wireguard-${date}";
  ...
  src = fetchzip {
    ...
    multihash = "QmehgDvHG1s6bAXrgJAZQDe2CocUVM6WMm3aLz1xwd5CaH";
    sha256 = "f608ec8e23fed5821dd044ed6aad08ac0a671260385d264f9bbc459b14bea393";
  };
