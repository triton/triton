...
let
  ...
  rev = "5e2be9240ca7af38960e7c8213fdb8f285df29d1";
  date = "2017-01-09";
in
stdenv.mkDerivation {
  name = "wireguard-${date}";
  ...
  src = fetchzip {
    ...
    multihash = "QmQfot2qTUaaH1bYwFmguamJYktdipw8Fghfo5Hcap189M";
    sha256 = "6954d7288a34bc6551edc8e0ea90ecd74eb5504ab14e2161f6826c099e153bc4";
  };
