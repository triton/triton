...
let
  ...
  rev = "33523a57554df852177a6f06c3d39b44d212040a";
  date = "2018-09-25";
in
stdenv.mkDerivation {
  ...
  src = fetchzip {
    ...
    multihash = "QmaSKzXCB6CWNA2zCn6sxC7bKMa1AkNNLLBTPmsediWdDF";
    sha256 = "8f7c8be11a308d27758f67ec834321a9af57897b24efe5d0e1fdcce690893873";
  };
