...
let
  ...
  optVirglrenderer = if isNix then null else shouldUsePkg virglrenderer;
  ...
  optLibcacard = if isNix then null else shouldUsePkg libcacard;
  ...
  optJemalloc = if isNix then null else shouldUsePkg jemalloc;
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [
    ...
    optMesa
    optEpoxy
  ] ++ optionals (malloc == "jemalloc") [
    optJemalloc
  ] ++ optionals (malloc == "tcmalloc") [
    optGperfTools
  ];
  ...
  configureFlags = [
    ...
    (mkEnable (optNettle != null)        "nettle"              null)
    (mkEnable false                      "gcrypt"              null)  # We are using nettle
    (mkEnable (optSDL2 != null)          "sdl"                 null)
    (mkWith   hasSDLAbi                  "sdlabi"              "2.0")
    (mkEnable (optGtk != null)           "gtk"                 null)
    # With    gtk-abi
    (mkEnable (optVte != null)           "vte"                 null)
    (mkEnable (optVirglrenderer != null) "virglrenderer"       null)
    ...
    (mkEnable (optLibcacard != null)     "smartcard"           null)
    ...
    (mkEnable (malloc == "tcmalloc")     "tcmalloc"            null)
    (mkEnable (malloc == "jemalloc")     "jemalloc"            null)
