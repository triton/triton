...
, gtk_doc, gtk2, python, pygobject, lua, libX11, libXext, libXrender, gobject-introspection
}:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [
    ...
    python pygobject3 pygtk lua libX11 libXext libXrender gobject-introspection gtk2
  ];
