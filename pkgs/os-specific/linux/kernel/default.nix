...
let
  ...
  sources = {
    ...
    "bcache" = let ver = "4.7.4-2016-09-15"; in {
      version = "4.7.4";
      urls = [
        "https://github.com/wkennington/linux/releases/download/bcachefs-${ver}/linux-bcachefs-${ver}.tar.xz"
      ];
      sha256 = "1da3a30bdd49de60ca9d725fc7e74ffa6ea6d78deb40a23fb9fcdae879434929";
