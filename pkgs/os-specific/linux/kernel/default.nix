...
let
  ...
  sources = {
    ...
    "bcache" = {
      version = "4.7.3";
      urls = [
        "https://github.com/wkennington/linux/releases/download/bcachefs-2016-09-13/linux-bcachefs-2016-09-13.tar.xz"
      ];
      sha256 = "1a7cb2018f1e4857b750b2a3f9d4cf4ba129592e4ffa3115f858c29e4f7943f5";
