...
let
  ...
  libpthreadstubs = (mkDerivation "libpthreadstubs" {
    ...
    builder = ./builder.sh;
    src = fetchurl {
      url = mirror://xorg/individual/lib/libpthread-stubs-0.1.tar.bz2;
  ...
  pixman = (mkDerivation "pixman" {
    ...
    builder = ./builder.sh;
    src = fetchurl {
      url = mirror://xorg/individual/lib/pixman-0.33.6.tar.bz2;
      sha256 = "0innjd2rjn1078r764nsklc28kf91bpaww0j4gx31xx25v6cdz8g";
    };
