...
let
  ...
  compiz = (mkDerivation "compiz" {
    ...
    nativeBuildInputs = [ ];
    buildInputs = [ dbus libXcomposite libXdamage libXrender ];
  ...
  fontadobe100dpi = (mkDerivation "fontadobe100dpi" {
    ...
    nativeBuildInputs = [ bdftopcf fontutil mkfontdir mkfontscale ];
    buildInputs = [ ];
  ...
  fontarabicmisc = (mkDerivation "fontarabicmisc" {
    ...
    nativeBuildInputs = [ bdftopcf mkfontdir ];
    buildInputs = [ ];
     configureFlags = "--with-fontrootdir=$(out)/lib/X11/fonts"; 
    meta.platforms = [
      "x86_64-linux"
  ...
  glamoregl = (mkDerivation "glamoregl" {
    ...
    nativeBuildInputs = [ ];
    buildInputs = [ dri2proto xorgserver ];
  ...
  xf86videoradeonhd = (mkDerivation "xf86videoradeonhd" {
    ...
    nativeBuildInputs = [ ];
    buildInputs = [ fontsproto glproto libdrm libpciaccess randrproto renderproto videoproto xextproto xf86driproto xorgserver xproto ];
