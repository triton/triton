...
autotools = callPackage ../all-pkgs/a/autotools { };
...
brotli_1-0-4 = callPackage ../all-pkgs/b/brotli {
  version = "1.0.4";
};
brotli = callPackageAlias "brotli_1-0-4" { };
...
cc-wrapper = callPackage ../all-pkgs/c/cc-wrapper { };
...
clang = pkgs.cc-wrapper {
  cc = callPackageAlias "llvm" { };
};
...
#  # Update this when adding the newest kernel major version!
  linuxPackages_latest = pkgs.linuxPackages_4-17;
