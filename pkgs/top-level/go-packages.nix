...
let
  ...
  ipfs = buildFromGitHub {
    version = 5;
    rev = "eca0486e1a51fb9e22e8f63248739f63347aa073";
    date = "2018-02-09";
    owner = "ipfs";
    repo = "go-ipfs";
    sha256 = "4b2eb5765d369751abb7dca70221f47c6db7f1c6113a8f30666ad3f71df51d46";
    gxSha256 = "0fhcgipp4ar87kpg8r8x96kpzqrnw6ca9dgsvqcd5mjr8mf32qzk";
    nativeBuildInputs = [
      gx-go.bin
    ];
