...
let
  ...
  snappy = buildFromGitHub {
    rev = "894fd4616c897c201d223c3c0c128e8c648c96a2";
    date = "2016-02-07";
    owner  = "golang";
    repo   = "snappy";
    sha256 = "0mnjkkj19kj62lfpz62rms4yab5m3kh5s5cns2rp02z02jdgfnbf";
  ...
  text = buildFromGitHub {
    rev = "6b2a19a9a1a1b404186b838a6b9d0c15bc9cc160";
    date = "2016-02-05";
    owner = "golang";
    repo = "text";
    sha256 = "125c768pbf4y924jgjmq415dzbrjdv52ldnvvf8y6wvacb8yl7fy";
    goPackagePath = "golang.org/x/text";
    goPackageAliases = [ "github.com/golang/text" ];
  };

  tools = buildFromGitHub {
    rev = "fe74a4186116b8d7dd38a723993e0d84f8834b34";
    date = "2016-02-05";
    owner = "golang";
    repo = "tools";
    sha256 = "03pdg141c2b6ybikzymsp3ra2c57l30ah0xngnqr5yfhvd6vjpxy";
  ...
  aws-sdk-go = buildFromGitHub {
    ...
    owner  = "aws";
    repo   = "aws-sdk-go";
    sha256 = "0ma3il8z2qs4rall0f0psip0ghjgk572lgyj8pl80l7kby2lj6zl";
  ...
  datadog-go = buildFromGitHub {
    ...
    owner = "DataDog";
    repo = "datadog-go";
    sha256 = "0wkb23nma0f6gr1yh8d775jf2b4r46c1wgq24dpdrjphpyw14fgw";
  };
  ...
  gcloud-golang = buildFromGoogle {
    rev = "7b74a8091e8f9470c1977a210a15dceac1da8824";
    repo = "cloud";
    sha256 = "02llkihwkq5b56zjw6qymrrjkzyp9q24dws9xx2bpj3r5i1pjv20";
  ...
  go4 = buildFromGitHub {
    date = "2016-02-03";
    rev = "1f1fbd40025c67fb003c7dc8e383a4c5b15f7c12";
    owner = "camlistore";
    repo = "go4";
    sha256 = "1lk5f3rm240h5zmn48wmavl09qqmqaafjni8wggb7xf3dslnvs3h";
  ...
  golang-lru = buildFromGitHub {
    date = "2016-02-02";
    rev = "ce7dece472ba96dab1807940f0614f3254f883e7";
    owner  = "hashicorp";
    repo   = "golang-lru";
    sha256 = "1xy0v831axym6l38mi3s2xi6qh5jy5079a2pf3iy4r9jd068a0an";
  };
  ...
  go-github = buildFromGitHub {
    date = "2016-02-04";
    rev = "05bd5edbd588f27c75831fce85fb48992b5322a6";
    owner = "google";
    repo = "go-github";
    sha256 = "09cdlbxcjsp83xvjk2k35pgwsid996djm3a6paga9kb1w3vrkvp0";
    buildInputs = [ oauth2 ];
  ...
  groupcache = buildFromGitHub {
    date = "2016-01-27";
    rev = "d995f8a6686adff0b1f2f20c52ef4114981d2006";
    owner  = "golang";
    repo   = "groupcache";
    sha256 = "11qqsm196v19wlaq39cchcvsf8vrdzd43rfsp39qpf253slc6jl1";
    buildInputs = [ protobuf ];
  };

  grpc = buildFromGitHub {
    rev = "66b94b9f6b45652d6824be23517979d31f27cd15";
    date = "2016-02-03";
    owner = "grpc";
    repo = "grpc-go";
    sha256 = "093sh1ic6qj8mn8nd91rk5h5gs2qkr5dk9ix09428niqxgm5fy0s";
  ...
  hcl = buildFromGitHub {
    date = "2016-01-30";
    rev = "e96d23138c76470c808bf6586bdaf981bbd25cae";
    owner  = "hashicorp";
    repo   = "hcl";
    sha256 = "0vjdd9hgdr5q93blzyppfg31ayhszjxy48hz5wcfj2a3im8rs031";
  };
  ...
  httprouter = buildFromGitHub {
    rev = "b74da820a2aa53314008e35ee79631ddba491aa0";
    owner  = "julienschmidt";
    repo   = "httprouter";
    sha256 = "05zdl49zwsik1kvcvb5rbl06a4xqwa3w7x6sz4ygws3si37zcrvh";
  };
  ...
  pq = buildFromGitHub {
    rev = "f59175c2986495ff94109dee3835c504a96c3e81";
    owner  = "lib";
    repo   = "pq";
    sha256 = "0fbms72lm10zhg23cls7a9s54njmvp5hfzkqd70p8q93xb15d5lp";
  };
  ...
  prometheus_common = buildFromGitHub {
    ...
    owner = "prometheus";
    repo = "common";
    sha256 = "10gixg6w4kssz18hv9q9gqnjic53hrl0hjr47lswyfhsl71rdk2i";
  ...
  vault = buildFromGitHub rec {
    ...
    owner = "hashicorp";
    repo = "vault";
    sha256 = "1i0lvzvbkrmr4xqffcs1940qsza2i7ak3mvn1xfqmhw3h4n5rkic";
