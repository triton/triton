...
let
  ...
  crypto = buildFromGitHub {
    ...
    owner    = "golang";
    repo     = "crypto";
    sha256 = "1jxa956syjwyw7drr7wciwa3xay27m33pffgbvinjwwmzpk0dfkz";
  ...
  text = buildFromGitHub {
    version = 2;
    rev = "ece019dcfd29abcf65d0d1dfe145e8faad097640";
    date = "2017-01-19";
    owner = "golang";
    repo = "text";
    sha256 = "1xnr48z07xbsd2cvbkqhrx2jfys1lpf81i7b640zasv7h448j4di";
  ...
  tools = buildFromGitHub {
    version = 2;
    rev = "f8ed2e405fdcbb42c55233531ad98721e6d1cb3e";
    date = "2017-01-26";
    owner = "golang";
    repo = "tools";
    sha256 = "0lmngpkkg7dsqz0y3hp014ar86m3vnc50pnl7zngzcrbmv3zgw9l";
  ...
  circonus-gometrics = buildFromGitHub {
    version = 2;
    date = "2017-01-27";
    rev = "d0057d867074f25fc724212cb76cf9010f8d6f4f";
    owner  = "circonus-labs";
    repo   = "circonus-gometrics";
    sha256 = "0qk4n6s0q58j97cwxbylc28ixha38dlcxdv4d7r8f6mn69x1qjfh";
    propagatedBuildInputs = [
      circonusllhist
      go-retryablehttp
    ];
  ...
  cobra = buildFromGitHub {
    ...
    owner = "spf13";
    repo = "cobra";
    rev = "c29ece4386f74084680e5e6d02d7b943ae630f63";
    date = "2017-01-26";
    sha256 = "05pikg6n1a58iyib19k9xhg2q8k7is2zif26awqpk5f2akq8zfc9";
    buildInputs = [
      pflag
      viper
    ];
  ...
  dns = buildFromGitHub {
    ...
    owner  = "miekg";
    repo   = "dns";
    sha256 = "024gf9zbw2k7ywyd14pmkf9lzjlbac0dhjwmcwzgag1p7yq56qgy";
  };
  ...
  google-cloud-go = buildFromGitHub {
    version = 2;
    date = "2017-01-26";
    rev = "2fad13a91cc5c2c321b67c95ca1e9ce123ebf5ac";
    owner = "GoogleCloudPlatform";
    repo = "google-cloud-go";
    sha256 = "0invnp994qiqi7pv47w9ijd6c1ai6vcndwyha6pnyqqk2c9wlqaz";
  ...
  google-api-go-client = buildFromGitHub {
    ...
    sha256 = "19nr1jdr8897c4ycyfknljkygxapl9bsscry4g1ks7lkq05d65qq";
  ...
  hcl = buildFromGitHub {
    version = 2;
    date = "2017-01-24";
    rev = "db4f0768927a665a06c32855186e1bc762bcc8f5";
    owner  = "hashicorp";
    repo   = "hcl";
    sha256 = "1yba2ig1wwy5bfinp2l6fyfg9pg6gzlv9a3b605cp15jl7dpimi1";
  };
  ...
  pflag = buildFromGitHub {
    ...
    owner = "spf13";
    repo = "pflag";
    rev = "a9a634f3de0a7529baded7ad6b0c7467d5c6eca7";
    date = "2017-01-25";
    sha256 = "0g3jkg3d2k7pxkgrqppha4bj1pv79kknhqbiqbh43ilzhzhp87cj";
  };
