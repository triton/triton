...
let
  ...
  crypto = buildFromGitHub {
    ...
    owner    = "golang";
    repo     = "crypto";
    sha256 = "0kdypzpwi2xpq3y1pqd9fm4fmc2yivpipswinxrawkzp0j9dllbl";
  ...
  geo = buildFromGitHub {
    version = 3;
    rev = "8826988ed49fc82b6fe084b2a471ed152f12261d";
    owner = "golang";
    repo = "geo";
    sha256 = "0i4yrz4zf660c4g56sngxixzv6snjvcwjnbpf4hb2lzp73qn1a1p";
    date = "2017-06-04";
  };
  ...
  net = buildFromGitHub {
    ...
    owner  = "golang";
    repo   = "net";
    sha256 = "0pgnf7s8hsvb3qpzn7j7p72ixbvdjfyiq5wfgirvfwci727rwz37";
  ...
  protobuf = buildFromGitHub {
    version = 3;
    rev = "e325f446bebc2998605911c0a2650d9920361d4a";
    date = "2017-06-13";
    owner = "golang";
    repo = "protobuf";
    sha256 = "0ndxm5p52vjrp7a3xdrdmgn0mx5ssynrr8qcbcbhyii1vb86xb22";
  ...
  sys = buildFromGitHub {
    ...
    owner  = "golang";
    repo   = "sys";
    sha256 = "0wwgmlrk598awfawgg0jym8k70nz128adn2hia3qs3drwhg5d50s";
  ...
  text = buildFromGitHub {
    ...
    owner = "golang";
    repo = "text";
    sha256 = "1miyhxrc29ii9hhhxmk7kv52g8dd2ji91bninrlnn2w7026jfq1h";
  ...
  tools = buildFromGitHub {
    version = 3;
    rev = "f2cd9d3b518cfa0e287637dd02a895ce2b587f14";
    date = "2017-06-14";
    owner = "golang";
    repo = "tools";
    sha256 = "0vp092am5gyw6rysi4h1bbqvpciwhch00yilv7qfgl228wsmw0hz";
  ...
  aws-sdk-go = buildFromGitHub {
    ...
    owner  = "aws";
    repo   = "aws-sdk-go";
    sha256 = "1f3k962a4ikmyiigafx5q18hrkfliyd9ragq0y91mxlp3lb2dqjb";
  ...
  azure-sdk-for-go = buildFromGitHub {
    version = 3;
    date = "2017-06-14";
    rev = "720c2a183bcccbe8a90f3159b63e1e2e5d4c9911";
    owner  = "Azure";
    repo   = "azure-sdk-for-go";
    sha256 = "1xajxx89nakqqalkyaj9dzfajaksbxw9d6rb7hjrbrpmiahm6i99";
  ...
  barcode = buildFromGitHub {
    ...
    owner = "boombuler";
    repo = "barcode";
    rev = "a4f901055aa151cd82782e5e2cd0000d5a48eed7";
    date = "2017-06-05";
    sha256 = "047xjysmhlybvx8gacjp2j41579c9ha35qkk7miy2k9y61v9mgj3";
  };
  ...
  btcd = buildFromGitHub {
    ...
    repo = "btcd";
    date = "2017-06-08";
    rev = "1bdb71328511a5225d6300c3c08a79172f667996";
    sha256 = "130j72lclsz8nkzy7sqy53a1ccsg8pp5z96j1j8crymny008qyh8";
    subPackages = [
      "btcec"
    ];
  };
  ...
  docker_cli = buildFromGitHub {
    version = 3;
    date = "2017-06-14";
    rev = "4c224a778638da8664b963d95948f0de8149a988";
    owner = "docker";
    repo = "cli";
    sha256 = "1m4h6i37xw1r9fk93sd2bapy10s7xc9kfmlzwhcppbsvgb914527";
    subPackages = [
  ...
  cobra = buildFromGitHub {
    ...
    date = "2017-06-12";
    sha256 = "1g2a2fz53fi0g4wm6zp45v6xhlglzhvglgvz1mx6mpsb9ib23mkf";
    buildInputs = [
      go-homedir
      mousetrap
      pflag
  ...
  etcd = buildFromGitHub {
    ...
    repo = "etcd";
    rev = "v3.2.0";
    sha256 = "1z84rvh9bphd820gbvmy02rsxb6p1f43cwkd1rv0nr5vh2if733a";
    buildInputs = [
      bolt
      btree
      urfave_cli
  ...
  google-cloud-go = buildFromGitHub {
    version = 3;
    date = "2017-06-14";
    rev = "e11d9d1a1722e191d3d017c08077f2c15189769a";
    owner = "GoogleCloudPlatform";
    repo = "google-cloud-go";
    sha256 = "0csqdh3ngdcfs6agr2ff3im7qw7acm2hclndr55f660pkxchg4qx";
  ...
  google-api-go-client = buildGoPackage rec {
    ...
    rev = "324744a33f1f37e63dd1695cfb3ec9a3e4a1cb05";
    ...
    src = fetchzip {
      ...
      sha256 = "0b0jpxldrn05wyf434fiw8m4nq5z4vli27798b8kygad8hvf8kv6";
    };
    buildInputs = [
      appengine
      genproto
  ...
  go-ethereum = buildFromGitHub {
    version = 3;
    date = "2017-06-13";
    rev = "335abdceb1d691e34526f9feb12870d6cdbc3d80";
    owner  = "ethereum";
    repo   = "go-ethereum";
    sha256 = "1ykvz8l5nmyvfbr1j12a9qsa3y6794yykk083p1l2bll55wl335m";
    subPackages = [
      "crypto/sha3"
    ];
  };
  ...
  go-sqlite3 = buildFromGitHub {
    version = 3;
    rev = "83c59d8440943c680f94ebbe51118df4244414d6";
    owner  = "mattn";
    repo   = "go-sqlite3";
    sha256 = "0sxhpjz8bpnh9wr4gjs66c1qv6vrcxn9bxw8fhx6s58y0f77nnr2";
    excludedPackages = "test";
    buildInputs = [
      goquery
    ];
  ...
  grpc = buildFromGitHub {
    version = 3;
    date = "2017-06-14";
    rev = "834dbd54e05e578c44aa018d5fab8d17892f9d4d";
    owner = "grpc";
    repo = "grpc-go";
    sha256 = "18c20b7im3hicbrlh0bfgh1ssid67dgbjnhwnhz2kx613wi9phcj";
  ...
  hugo = buildFromGitHub {
    ...
    repo = "hugo";
    rev = "v0.22.1";
    sha256 = "0nighwf3lbm4z0gixk1jarzr161bhzzir9k8yazl48lqy1d21d9r";
    buildInputs = [
      ace
      afero
      amber
  ...
  image-spec = buildFromGitHub {
    version = 3;
    rev = "df6f3c57dafbbf39d98c24fa6ab509183cfa3efc";
    owner  = "opencontainers";
    repo   = "image-spec";
    sha256 = "0ddwp8mdga4xfvjpqci7ch6bnwwkhrgrbcyszpmp8yy043m7n63b";
    date = "2017-06-07";
    propagatedBuildInputs = [
      errors
      go4
  ...
  ledisdb = buildFromGitHub {
    version = 3;
    rev = "bc27c99e3ccf9b5344e9f873e8a7148eeededd76";
    owner  = "siddontang";
    repo   = "ledisdb";
    sha256 = "0qwhaq2qhfxx7s1chac7mcvh872wd7398v6dls7wa39kib6s2ayd";
    date = "2017-06-12";
    prePatch = ''
  ...
  mc = buildFromGitHub {
    ...
    owner = "minio";
    repo = "mc";
    rev = "c32b1ea48b651125e33015ea0d1596cb377685a4";
    sha256 = "0ks12c3h4rh1zfrg6k292c8ghjbml4wlfxsdrbic3cmairf2mrsz";
    propagatedBuildInputs = [
      cli_minio
      color
      go-colorable
  ...
  memberlist = buildFromGitHub {
    version = 3;
    rev = "16fe34d996eba2b68f6f46f26c51c617c6bc1bf0";
    owner = "hashicorp";
    repo = "memberlist";
    sha256 = "1010c88qq8yavqg461rvzv231fqwyl3sc43ia1imm29lc8gw655n";
    propagatedBuildInputs = [
      dns
      ugorji_go
      armon_go-metrics
  ...
  minio-go = buildFromGitHub {
    ...
    owner = "minio";
    repo = "minio-go";
    rev = "8d69ba85cf79a5134321e7b10a7dbf3860511001";
    sha256 = "06cc2ac1pv839s6c1jdm9lxmwjzaqjf056smlv5ma054g80b39k3";
    meta.useUnstable = true;
    date = "2017-06-13";
  };
  ...
  moby = buildFromGitHub {
    ...
    owner = "moby";
    repo = "moby";
    rev = "6d92b0ee15cff0d5fade6533f696c7bc9f314021";
    date = "2017-06-14";
    sha256 = "0diilqhfff6ajmf6m27f7y9ad2zwfwj720yfzk7z2p305qf06qa2";
    goPackageAliases = [
  ...
  mysql = buildFromGitHub {
    version = 3;
    rev = "a825be04c652d01442384e9dcdf2cdc3f1eda67f";
    owner  = "go-sql-driver";
    repo   = "mysql";
    sha256 = "0ykym5ybjc4qra942mi8hjr7iyrs5955bxqsvzqv80vyandgl1ci";
    postPatch = ''
      grep -r '+build appengine' -l | xargs rm
    '';
    date = "2017-06-10";
  ...
  procfs = buildFromGitHub {
    version = 3;
    rev = "a3bfc74126ea9e45ee5d5c6f7fc86191b7d488fb";
    date = "2017-06-09";
    owner  = "prometheus";
    repo   = "procfs";
    sha256 = "06lgibb5spp0jrmwqyx56yvy952cpwsrh60mvdfvsgc3swvz3nxh";
  };
  ...
  rclone = buildFromGitHub {
    ...
    repo = "rclone";
    date = "2017-06-14";
    rev = "9876ba53f8e0bfa8b355650d90c8a727825a82f7";
    sha256 = "1l8waj1p00063jv9z1vdc8bx4iznwmsr55z4l02q39s1py695ikh";
    propagatedBuildInputs = [
      aws-sdk-go
      cgofuse
      cobra
  ...
  reedsolomon = buildFromGitHub {
    ...
    repo = "reedsolomon";
    date = "2017-06-06";
    rev = "d4658f22be1d1b0a2e3b3f169489d6533da27ef7";
    sha256 = "16jzlwmh16zi2azvjqx6g6phngmad1ma4wb0sdx61cjf5ynn5hgq";
    propagatedBuildInputs = [
      cpuid
    ];
    meta.useUnstable = true;
  ...
  spec = buildFromGitHub {
    version = 3;
    date = "2017-06-06";
    rev = "e81a13315ac92ce3e73075856c5cd50301695405";
    owner  = "go-openapi";
    repo   = "spec";
    sha256 = "0zn70za09sylf0z9484i2qmv013nsnlpabh5a6ria44shf6q0qsd";
    propagatedBuildInputs = [
      jsonpointer
      jsonreference
      swag
  ...
  teleport = buildFromGitHub {
    ...
    owner = "gravitational";
    repo = "teleport";
    sha256 = "1qzar36ilgk9r5a2pkqmlvvq83rz61a26l2sqkbfxcka7434bnwy";
    buildInputs = [
      aws-sdk-go
      bolt
      configure
  ...
  termbox-go = buildFromGitHub {
    ...
    owner = "nsf";
    repo = "termbox-go";
    sha256 = "1bhwfgm884jg0mdcz3iy5km2c50h3xsxa9ynp0a1fz4ny4xrv947";
    propagatedBuildInputs = [
      go-runewidth
    ];
  };
  ...
  viper = buildFromGitHub {
    ...
    owner = "spf13";
    repo = "viper";
    rev = "a1ecfa6a20bd4ef9e9caded262ee1b1b26847675";
    date = "2017-06-09";
    sha256 = "07b5k37hjd88966q7rbbx9nia6h7gyyzpl600xy13wblf2pqbknd";
    buildInputs = [
      crypt
      pflag
    ];
