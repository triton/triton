...
let
  ...
  crypto = buildFromGitHub {
    version = 2;
    rev = "c2303dcbe84172e0c0da4c9f083eeca54c06f298";
    date = "2017-04-05";
    owner    = "golang";
    repo     = "crypto";
    sha256 = "1xm538ap25ih9cx3zaf1kh4jbs50da9p64b9y87qxbg7w74b6riv";
  ...
  net = buildFromGitHub {
    version = 2;
    rev = "ffcf1bedda3b04ebb15a168a59800a73d6dc0f4d";
    date = "2017-03-29";
    owner  = "golang";
    repo   = "net";
    sha256 = "0hhsyscnyx2jzzhws2h7hrwwcwm4j263pcca1s5pzqlb02ms28jq";
  ...
  sys = buildFromGitHub {
    version = 2;
    rev = "493114f68206f85e7e333beccfabc11e98cba8dd";
    date = "2017-04-03";
    owner  = "golang";
    repo   = "sys";
    sha256 = "0zkgz5a9hbav05hcydkwzdnk26d41vyqwayfwcdjqrji03jmz4cz";
  ...
  text = buildFromGitHub {
    ...
    owner = "golang";
    repo = "text";
    sha256 = "0mvkb72mkzaz3r5s2p50y0qbf0rljmfbsfdfsq3alzxd5hh895d3";
  ...
  tools = buildFromGitHub {
    version = 2;
    rev = "5054e612afecd2460e8659117a716cb5b58d4b88";
    date = "2017-04-05";
    owner = "golang";
    repo = "tools";
    sha256 = "1skvfihnj04k44cf4zc3fmlgk78c6vlavyyswhli38xkbqb400xx";
  ...
  aws-sdk-go = buildFromGitHub {
    ...
    owner  = "aws";
    repo   = "aws-sdk-go";
    sha256 = "0cnl5j6wkm9lhak40yl8i7f53hs4q63jlq3d260vqccsi32ns8k4";
  ...
  azure-sdk-for-go = buildFromGitHub {
    ...
    sha256 = "a7702a9ede17fa65a412e3e8fa6179899e7af25d0c87d0bcc191b801ae9a95f3";
  ...
  b = buildFromGitHub {
    version = 2;
    date = "2017-03-29";
    rev = "aaaa43c92e509a827e63540510bc94c3003ef2e1";
    owner  = "cznic";
    repo   = "b";
    sha256 = "142sx6y21f857686p28aakk3g2k4kha2qnvaj942iik3w03n6csi";
  ...
  cobra = buildFromGitHub {
    ...
    owner = "spf13";
    repo = "cobra";
    rev = "7aeaa2cce6ae7e18d2a6ee597b60ee137e999bd9";
    date = "2017-04-02";
    sha256 = "1dqzn8svm9n2fyr6gy6insv869576wiyxyq64b0y38i4fbrqb7gz";
    buildInputs = [
      mousetrap
      pflag
      viper
  ...
  consul = buildFromGitHub rec {
    ...
    owner = "hashicorp";
    repo = "consul";
    sha256 = "0idlblblli2rg01jxkl9ppsly9whlynbfxndyzslzznsyj4mrlrw";
  ...
  dns = buildFromGitHub {
    version = 2;
    rev = "dcffd061aaeef4f0ab8369d0443146462b64ea6d";
    date = "2017-03-31";
    owner  = "miekg";
    repo   = "dns";
    sha256 = "1yj7m05krk860dp94kl4d9rddw8z8md958nsjfrqvi1piq525lbz";
  };
  ...
  docker = buildFromGitHub {
    version = 2;
    rev = "833f1f44245c9e9514b931b19831ee58594f6b10";
    owner = "docker";
    repo = "docker";
    sha256 = "1f95cjvs660bpnad6v5ncbq6lyxvmc3k4m9drm3msyx3xf35bgc5";
    meta.useUnstable = true;
    date = "2017-04-05";
    propagatedBuildInputs = [
  ...
  etcd = buildFromGitHub {
    ...
    owner = "coreos";
    repo = "etcd";
    rev = "d42c1f5131932bef899cedb31d42b2e12bc5c49c";
    sha256 = "0czn76s0hf1r3cfxk4a7kvsjk1b024yalbz48gbbzx1361imr8bv";
    buildInputs = [
      bolt
      btree
      urfave_cli
  ...
  gjson = buildFromGitHub {
    ...
    repo = "gjson";
    date = "2017-04-05";
    rev = "01736e2fafeab19684bc0c2d1ee0a600418d7b2a";
    sha256 = "025l49xi1qil91a99griia20mg5c8xi7dv9bzi8rsg4l3ki3fq1f";
    propagatedBuildInputs = [
      match
    ];
  };
  ...
  gocql = buildFromGitHub {
    version = 2;
    rev = "f8b6dcaf4f8a770652c11e7e94b517fcb706fce8";
    owner  = "gocql";
    repo   = "gocql";
    sha256 = "1nkhf3q58y6hclf3vmd2wp0jbpdxj8vvlbkrkky3gdw5frs159vy";
    propagatedBuildInputs = [
      inf_v0
      snappy
  ...
  google-cloud-go = buildFromGitHub {
    version = 2;
    date = "2017-04-05";
    rev = "ee12de41f35ce1867cec29587f14bd686362e4fa";
    owner = "GoogleCloudPlatform";
    repo = "google-cloud-go";
    sha256 = "01pp7l81969y11d2ij3i7l2q5cggi59cqdw49p9xc08r13l0phm6";
  ...
  goutils = buildFromGitHub {
    version = 2;
    rev = "8220d1bdf8df66488e5e3ca876b0d426d8f16bc6";
    date = "2017-03-31";
    owner = "couchbase";
    repo = "goutils";
    sha256 = "0gc2543m6j7ab0a685fd3xcaww15qzympksnws2svm0n63xl5n3a";
    buildInputs = [
      cbauth
      go-couchbase
      gomemcached
  ...
  govalidator = buildFromGitHub {
    version = 2;
    rev = "2c14e1cca90af49b3b21fe2d7aaa8cc7f9da2ff8";
    owner = "asaskevich";
    repo = "govalidator";
    sha256 = "0q26c0gw9bsdysrirq377p2p8inzw1by93x1m4xh1zzbi8qw654i";
    date = "2017-04-02";
  };
  ...
  go-couchbase = buildFromGitHub {
    version = 2;
    rev = "67035e75f58e66670b74d7eae1c52f5c9babc105";
    owner  = "couchbase";
    repo   = "go-couchbase";
    sha256 = "1q2wfh1avr5mnacs5gy3fcyhbsz6asyz3xcaq0a5wi0yxpl1vz58";
    date = "2017-03-30";
    goPackageAliases = [
  ...
  go-crypto = buildFromGitHub {
    version = 2;
    rev = "3e9e98fd9221edf772b06f22e9a447fbbac18804";
    owner  = "keybase";
    repo   = "go-crypto";
    sha256 = "1cz4hddlrhcagyif4gdqyg57ffr351mjmhjkm3n8w0kz4dgs5m7q";
    date = "2017-03-29";
    propagatedBuildInputs = [
      ed25519
    ];
  ...
  go-dockerclient = buildFromGitHub {
    version = 2;
    date = "2017-04-03";
    rev = "e24e809e9db395f1e3c85af1b88f2002023610f5";
    owner = "fsouza";
    repo = "go-dockerclient";
    sha256 = "0pq8crf6sz5snwpd9m2f8bgigjkl1s1cryp6yrif918sx8ygk4yp";
    propagatedBuildInputs = [
  ...
  go-ethereum = buildFromGitHub {
    version = 2;
    date = "2017-04-05";
    rev = "cc303017c3f145441e583b5bb10ee3070b44cc50";
    owner  = "ethereum";
    repo   = "go-ethereum";
    sha256 = "1x5whnxswj47jli9pvv3a1mwigy6ml0gyy4j4ydv1c7l3s14fxwz";
    subPackages = [
      "crypto/sha3"
    ];
  };
  ...
  go-getter = buildFromGitHub {
    version = 2;
    rev = "615ccd8621bdb3837e18be586ce15655ef52b185";
    date = "2017-04-04";
    owner = "hashicorp";
    repo = "go-getter";
    sha256 = "1bc65z7iw238smscic97vhyrq2nlily60lgp24z62z5cfj0aax53";
    propagatedBuildInputs = [
      aws-sdk-go
      go-homedir
      go-netrc
  ...
  go-github = buildFromGitHub {
    version = 2;
    date = "2017-04-01";
    rev = "12363ffc10018c93407ebf303040586d55957271";
    owner = "google";
    repo = "go-github";
    sha256 = "07ncfm3lhb5j3wyjfazkrndp63n0r0qnd4zf5bvpjp91sg0s96l4";
    buildInputs = [
      appengine
      oauth2
    ];
  ...
  go-mssqldb = buildFromGitHub {
    version = 2;
    rev = "05a5564207042f04d43d186d82e195a7f5699d48";
    owner = "denisenkom";
    repo = "go-mssqldb";
    sha256 = "12jc76gngy7k55ah4zxrrsfq3r91lsbddlkmz28pmaavqqmsjaaq";
    date = "2017-04-03";
    buildInputs = [
      crypto
      net
  ...
  grpc = buildFromGitHub {
    version = 2;
    date = "2017-04-04";
    rev = "f45e6e3b301d8eaacc87dc7242ae8b1a43595528";
    owner = "grpc";
    repo = "grpc-go";
    sha256 = "0gn3f80917kvlwwp0y29vb0my1k750721yn34in7i24n1av9ch55";
  ...
  grpc-gateway = buildFromGitHub {
    ...
    owner = "grpc-ecosystem";
    repo = "grpc-gateway";
    sha256 = "10bj1ii6i93n72k0qwzqdqwfk0yns1c0p57lcchnx4kj13gnhzbq";
    propagatedBuildInputs = [
      genproto
      glog
      grpc
  ...
  kcp-go = buildFromGitHub {
    ...
    repo = "kcp-go";
    rev = "v3.14";
    sha256 = "04760f2bc3lvc4i703nsin1w20n1mdqdw3k1961375sm4l6jd5s5";
    propagatedBuildInputs = [
      crypto
      errors
      net
  ...
  lego = buildFromGitHub {
    version = 2;
    rev = "7668fe9274a23d6791e28c76056ab00134fbda04";
    owner = "xenolf";
    repo = "lego";
    sha256 = "1lm81vsj85aj6lsjzpzry5dprwyv9p55sx39z4y1abxz3k8r6iig";
    buildInputs = [
      auroradnsclient
      aws-sdk-go
      azure-sdk-for-go
  ...
  mc = buildFromGitHub {
    ...
    owner = "minio";
    repo = "mc";
    rev = "7084a4361e3511dff9e33c24e2ac0e2b952b1565";
    sha256 = "1sh96izmg916lprsqngyrq5zapv3lx9qn4v1zgyf4x17hgjvvn4n";
    propagatedBuildInputs = [
      cli_minio
      color
      go-colorable
  ...
  minio-go = buildFromGitHub {
    ...
    owner = "minio";
    repo = "minio-go";
    rev = "bd69921c7f648abb5807b400b4a2b7a256ff9eb2";
    sha256 = "1ixygmiakm5jp7yi0n6wlanh7g56bh6n0bk8q194nbv39awpxcai";
    meta.useUnstable = true;
    date = "2017-04-05";
  };
  ...
  netlink = buildFromGitHub {
    version = 2;
    rev = "aec6f885c2544dafc5baedfc95fdd15e75a1b1b4";
    owner  = "vishvananda";
    repo   = "netlink";
    sha256 = "0j0b1y1h7q9nsjq6zx9m0jzrlwxk8pldw7x2ns39yq310ahl1xbn";
    date = "2017-03-31";
    propagatedBuildInputs = [
      netns
    ];
  ...
  pflag = buildFromGitHub {
    ...
    owner = "spf13";
    repo = "pflag";
    rev = "9a906f17374922ed0f74e1b2f593d3723f2ffb00";
    date = "2017-04-05";
    sha256 = "0d9p2632izi5yjd6lw2w12xxpnj42a1ysmrfcb6251qa4k6kjiw4";
  };
  ...
  pkg = buildFromGitHub {
    ...
    owner  = "coreos";
    repo   = "pkg";
    rev = "099530d80109cc4876ac866c38dded19786731d0";
    sha256 = "07qkjgpgpii98yw1i57p519xf8bbixrwzkh7q53dgzrn4ky76mf9";
    buildInputs = [
      crypto
      yaml_v1
    ];
  ...
  prometheus_client_golang = buildFromGitHub {
    ...
    owner = "prometheus";
    repo = "client_golang";
    sha256 = "1c4wzh5f7ckqcfr8hcc19pchz4j93nl8mgsgzjffqj6ghdqhs17f";
    propagatedBuildInputs = [
      goautoneg
      net
      protobuf
  ...
  rclone = buildFromGitHub {
    ...
    owner = "ncw";
    repo = "rclone";
    rev = "2fd86c93fcb4b8e9ecd2e042d63d0b3d901868df";
    sha256 = "0ng6kcxhz6piya2hilzab1x4ny1p40as88xbkfzfy003lxza08q1";
    propagatedBuildInputs = [
      aws-sdk-go
      cobra
      crypto
  ...
  sha256-simd = buildFromGitHub {
    ...
    repo = "sha256-simd";
    date = "2017-04-04";
    rev = "6124d070eb4e7001c244b6ccc282620a5dce44a0";
    sha256 = "03h2vqc134bm8sd6ls1c2y55hlrx15605ax4saxixafw8k2xwrfl";
  };
  ...
  syncthing = buildFromGitHub rec {
    ...
    owner = "syncthing";
    repo = "syncthing";
    sha256 = "1p31y0ym9hrbx88v4b23cm5npl6pvx5vgicdpaj7pvj17ww157f5";
  ...
  zap = buildFromGitHub {
    ...
    owner  = "uber-go";
    repo   = "zap";
    sha256 = "0jqlla64wrblmgxlsjbvbjrrckr5454w46vyfg70nal5j97hf4jv";
